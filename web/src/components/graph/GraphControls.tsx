...
export function GraphControls({ onZoomIn, onZoomOut, onFit }: GraphControlsProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 space-y-4">
      <h3 className="font-medium text-gray-900 dark:text-white">Controls</h3>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <button
            type="button"
            onClick={onZoomIn}
            className="px-3 py-1 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 dark:text-gray-200 rounded text-sm"
          >
            +
          </button>
          <button
